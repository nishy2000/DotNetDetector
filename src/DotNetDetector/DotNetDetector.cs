                ...
                switch (assembly.ManifestModule.Name.ToLowerInvariant())
                {
                    ...
                    case "system.runtime.dll":
                        ...
                        if (isNetCore && itemVersion == null)
                        {
                            ...
                            var infoVersionDetail = infoVersionAttr.InformationalVersion.Split(new char[] { '+' }, 2).FirstOrDefault();
                            var infoVersions = infoVersionDetail.Split(new char[] { '-' }, 2);
                            ...
                            if (Version.TryParse(infoVersion, out Version ver))
                            {
                                ...
                                if (productAttr != null && productAttr.Product.Contains(".NET Core"))
                                {
                                    itemVersion = ver;
                                }
                            }
